...
public class TrackerHandlerTest {
    ...
    public void testTracking() throws Exception {
        ...
        try {
            ...
            Client client = new Client(getClass().getSimpleName(), new InetSocketAddress("localhost", 6881));
            client.start();
    ...
    public void testFailover() throws Exception {
        Client client = new Client(getClass().getSimpleName(), new InetSocketAddress("localhost", 6882));
        client.start();
