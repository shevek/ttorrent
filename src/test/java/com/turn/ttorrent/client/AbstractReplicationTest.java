...
public class AbstractReplicationTest {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(AbstractReplicationTest.class);
	...
	public void setUp() throws Exception {
		...
		File dir = TorrentTestUtils.newTorrentDir(getClass().getSimpleName()
				+ ".seed");

		TorrentCreator creator = TorrentTestUtils
				.newTorrentCreator(dir, 126071);
	...
	@Nonnull
	protected Client leech(@Nonnull CountDownLatch latch, int i)
		...
		c.addClientListener(new ReplicationCompletionListener(latch,
				TorrentHandler.State.SEEDING));
		leechers.add(c);
		return c;
	}

	protected void await(@Nonnull CountDownLatch latch)
